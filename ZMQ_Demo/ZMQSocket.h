...
- (NSMutableData *)receiveDataWithFlags:(ZMQMessageReceiveFlags)flags;
- (ssize_t)receiveDataWithFlagsBack:(ZMQMessageReceiveFlags)flags buffer:(void *)buf baseSize:(size_t)len;
